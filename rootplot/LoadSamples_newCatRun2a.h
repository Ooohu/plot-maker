...
//This variation is to use subrun_number%3==0 for checking some random feature due to statistics
...
Samples LoadRun2aRHCData( TString AmassBDTTag ){

	Samples data("NuMI Data R2a RHC","/pnfs/uboone/persistent/users/klin/MCC9/ntuples/liteTtrees_2s0t/gleeNtuples_numi_run2adata_2s0t.root","vertex_tree","run_number<8782");
	data.SetPOT(3.12e18);

	//Add Friends ~ Start
	TString BDTFileTag = "NuMIDataR2aRHC";
	TString ClassifierTag = "PionClassifier";
