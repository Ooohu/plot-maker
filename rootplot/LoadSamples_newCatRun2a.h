...
//scalings_run1 = { "nu":1./9.98e20, "dirt":1.0*0.75/1.55e21, "beamoff": 0.98*(6230439.0/9186361.390000)}
...
Samples LoadRun2aAll( TString AmassBDTTag ){ // FOR CHECKING
	Samples tmpSample("All MC Backgrounds:", "/pnfs/uboone/persistent/users/klin/MCC9/ntuples/liteTtrees_2s0t/gleeNtuples_numi_run2aMCoverlay_2s0t.root","vertex_tree","subrun_number%3==0");
	...
	tmpSample.SetPOT(9.98e20);
	tmpSample.SetScale(3.0242215);//Have used half for training;

	//Add reweighting friend
	tmpSample.AddFriend( "/pnfs/uboone/persistent/users/klin/MCC9/ntuples/liteTtrees_2s0t/gleeNtuples_numi_run2aMCoverlay_2s0t.root","eventweight_tree");
...
Samples LoadRun2aOnepi0( TString AmassBDTTag ){
	Samples tmpSample("1#pi^{0}", "/pnfs/uboone/persistent/users/klin/MCC9/ntuples/liteTtrees_2s0t/gleeNtuples_numi_run2aMCoverlay_2s0t.root","vertex_tree","mctruth_num_exiting_pi0==1 &&subrun_number%3==0");
...
Samples LoadRun2aNueCC( TString AmassBDTTag ){
	...
	Samples tmpSample("CC#nu_{e}/#bar{#nu_{e}}", "/pnfs/uboone/persistent/users/klin/MCC9/ntuples/liteTtrees_2s0t/gleeNtuples_numi_run2aMCoverlay_2s0t.root","vertex_tree","!(mctruth_num_exiting_pi0==1)&&mctruth_cc_or_nc==0&& fabs(mctruth_nu_pdg)==12 && subrun_number%3==0");
...
Samples LoadRun2aNumuCC( TString AmassBDTTag ){
	...
	Samples tmpSample("CC#nu_{#mu}/#bar{#nu_{#mu}}", "/pnfs/uboone/persistent/users/klin/MCC9/ntuples/liteTtrees_2s0t/gleeNtuples_numi_run2aMCoverlay_2s0t.root","vertex_tree","!(mctruth_num_exiting_pi0==1)&&mctruth_cc_or_nc==0&& fabs(mctruth_nu_pdg)==14 && subrun_number%3==0");
...
Samples LoadRun2aOtherCC( TString AmassBDTTag ){//empty

	Samples tmpSample("Other CC", "/pnfs/uboone/persistent/users/klin/MCC9/ntuples/liteTtrees_2s0t/gleeNtuples_numi_run2aMCoverlay_2s0t.root","vertex_tree","!(mctruth_num_exiting_pi0==1 ) && mctruth_cc_or_nc==0&&!(fabs(mctruth_nu_pdg)==12) &&!(fabs(mctruth_nu_pdg)==14)&& subrun_number%3==0");
...
Samples LoadRun2aInCryoOther( TString AmassBDTTag ){
	Samples tmpSample("InCryoOther", "/pnfs/uboone/persistent/users/klin/MCC9/ntuples/liteTtrees_2s0t/gleeNtuples_numi_run2aMCoverlay_2s0t.root","vertex_tree","!(mctruth_num_exiting_pi0==1 ) && mctruth_cc_or_nc==1 && subrun_number%3==0");
	tmpSample.SetPlotStyle(kMagenta+3,1001);
	tmpSample.SetWeight("ppfx_cv*weightSplineTimesTune"); // vulnerable to inf weight of spline_tune_good
	tmpSample.SetPOT(9.98e20);
	tmpSample.SetScale(3.0242215);
