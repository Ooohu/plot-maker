...
//	
//		//boolean 
//		sys_its_CV.push_back(booleader( pSys->Attribute("isCV")));
//		sys_its_multithrows.push_back(booleader( pSys->Attribute("isMultithrows")));
//		sys_its_OpticalModel.push_back(booleader(pSys->Attribute("OpticalModel")));
//
...
//		sys_for_files.push_back(tokenizer( aliased_bdtfiles.c_str()));
//
//		sys_vars.push_back(tokenizer( pSys->Attribute("var")));
//		sys_vars_name.push_back(tokenizer( pSys->Attribute("varnam")));
//
