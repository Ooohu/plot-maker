...
std::vector< Vars> SetMultipleVars(){
    ...
    Vars varMassC("Corrected Reco Invariant Mass [GeV]", "1.21*sqrt(2.0*reco_shower_energy_max[i_shr[0]]*reco_shower_energy_max[(i_shr[1])]*(1.0-(reco_shower_dirx[0]*reco_shower_dirx[1] + reco_shower_diry[0]*reco_shower_diry[1] + reco_shower_dirz[0]*reco_shower_dirz[1])))/1000", {40,0,0.4}, false, {0.815963, 0.605724, 0.187531, 0.148772, 1.28208, 0.350643, 0.259607, 0.229976, 0.377372, 0.30608, 0.391048, 0.348099, 0.469922, 0.302482, 0.259055, 1.03359, 0.245466, 0.468248, 0.401797, 0.385286, 0.46464, 0.92721, 1.56121, 0.588306, 0.876683, 0.528669, 0.725196, 0.347225, 0.920725, 0.31904, 0.693115, 0.750016, 0.822445, 0.477485, 1.44872, 1.1176, 0.958325, 0.846179, 0.761791, 10.043});
    ...
    //Cosmic Killer
    Vars var_yness1("Shower Zenith Angle, Leading","(180/TMath::Pi())*TMath::Min(fabs(acos(reco_shower_diry[i_shr[0]])), fabs(acos(-reco_shower_diry[i_shr[0]])))",{20,0,90}, false, {1.21622, 0.524141, 0.388667, 0.357176, 0.451303, 0.298778, 0.336034, 0.418035, 0.237405, 0.418215, 0.182311, 0.277402, 0.147245, 0.267301, 0.348851, 0.183277, 0.244704, 0.233577, 0.262569, 0.164648});
...
//    Vars var_bdtPionAma0146L("ma0146 - Pion Accurate Classifier (Log y)","ma0146PionAccurateClassifier",        {bins,0,1}, true, {0.235558, 0.322279, 0.245403, 0.454496, 0.561818, 0.376424, 0.849523, 0.403889, 0.593547, 0.616031});//DetVar
//    Vars var_bdtPionAma0146L("ma0146 - Pion Accurate Classifier (Log y)","ma0146PionAccurateClassifier",        {bins,0,1}, true, {0.164917, 0.0231476, 0.329276, 0, 0, 1.98675, 0, 0, 0, 0});//GENIE
    Vars var_bdtPionAma0146L("ma0146 - Pion Accurate Classifier (Log y)","ma0146PionAccurateClassifier",        {bins,0,1}, true, {0.1875, 0.8652, 0.6414, 0.6077, 2.1033,2.0300, 0.6161, 0.8845, 0.7191, 0.6924});//DetVar+GENIE
...
//	std::vector< Vars> allVars = {var_yness1, var_bdtPionAma0146L, varMassC};
