...
#include "LoadSamples_FHCRuns_Run2.h"
#include "CommonCut.C"

void TTree2StackOverlays_run2aFHC_axion3massPoints(){
	...
	TString Label = "NuMIaxionsRun2aFHC"+axiontag+"_2s0t_twoMassPoints";
...
//	Samples ext			= LoadRun2aEXT		(axiontag);
	Samples ext			= LoadRun2aFHCEXT		(axiontag);

	Samples Onepi0		= LoadRun2FHCOnepi0 (axiontag);
	Samples NueCC		= LoadRun2FHCNueCC (axiontag);
	Samples NumuCC		= LoadRun2FHCNumuCC (axiontag);
	Samples InCryoOther = LoadRun2FHCInCryoOther (axiontag);

	Samples dirt		= LoadRun2FHCDirt		(axiontag);
