...
std::vector< Vars> SetMultipleVars(){
	...
	Vars varCosOpnAng("Cosine of Reco Diphoton Opening Angle", "reco_shower_dirx[0]*reco_shower_dirx[1]+reco_shower_diry[0]*reco_shower_diry[1]+reco_shower_dirz[0]*reco_shower_dirz[1]", {8,-1,1});//LOGY - true
	...
	Vars var_bdtPionL(	"Pion Focused   BDT LOGY","NuMIRHCRun3Pre16880AxionV3ma003PionClassifier_mva",		{24,0,1}, true);
	Vars var_bdtNueCCL(	"NueCC Focused  BDT LOGY","NuMIRHCRun3Pre16880AxionV3ma003NueCCClassifier_mva",	{24,0,1}, true);
