...
//BDT Stuffs Below
	...
	std::vector< Vars> allVars = {var_bdtPionAma011L,var_bdtPionAma0146L,var_bdtPionAma03L,var_bdtPionAma04L,var_bdtPionAma052L,var_bdtPionAma068L,var_bdtPionAma084L};
