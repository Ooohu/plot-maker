...
// PREPARE SAMPLES -----------------------------------------------------------------
	...
	Samples axion = LoadAxions("ma003");
	Samples nc1pi0 = LoadNC1pi0("ma003");
	Samples nc0pi0 = LoadNC0pi0("ma003");
	Samples ccnue = LoadCCnue("ma003");
	Samples ccnumu1pi = LoadCCnumu1pi("ma003");
	Samples ccnumu0pi = LoadCCnumu0pi("ma003");
	Samples other = LoadOthers("ma003");
	Samples dirt = LoadDirt("ma003");
	Samples data = LoadData("ma003");
	Samples ext = LoadEXT("ma003");
