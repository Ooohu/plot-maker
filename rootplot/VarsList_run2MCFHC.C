...
std::vector< Vars> SetMultipleVars(){
    ...
    Vars var_bdtPionAma0146L("ma0146 - Pion Accurate Classifier (Log y)","ma0146PionAccurateClassifier",        {bins,0,1}, true, {1.1544, 1.75553, 1.46951, 1.10218, 1.76604, 1.22228, 2.11944, 1.0906, 1.76668, 3.0164});
